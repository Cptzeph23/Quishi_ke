    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session_key', models.CharField(blank=True, help_text='For anonymous user sessions', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extracted_filters', models.JSONField(blank=True, help_text='Structured filters extracted from natural language', null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
